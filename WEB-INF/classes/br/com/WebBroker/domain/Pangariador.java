...
public class Pangariador {
	...
	public String toString() {
		return "Pangariador [idtb_pessoafisica=" + idtb_pessoafisica
				...
				+ ", pf_datanasc=" + pf_datanasc + ", pf_data_adm="
				+ pf_data_adm + ", pf_DataExped=" + pf_DataExped
