...
public class Pjuridicas {

	
	private String tb_pj_ddd01;
	private String tb_pj_ddd02;
	private String tb_pj_fone01;
	private String tb_pj_fone02;
	...
	public String getTb_pj_ddd01() {
		return tb_pj_ddd01;
	}
	public void setTb_pj_ddd01(String tb_pj_ddd01) {
		this.tb_pj_ddd01 = tb_pj_ddd01;
	}
	public String getTb_pj_ddd02() {
		return tb_pj_ddd02;
	}
	public void setTb_pj_ddd02(String tb_pj_ddd02) {
		this.tb_pj_ddd02 = tb_pj_ddd02;
	}
	public String getTb_pj_fone01() {
		return tb_pj_fone01;
	}
	public void setTb_pj_fone01(String tb_pj_fone01) {
		this.tb_pj_fone01 = tb_pj_fone01;
	}
	public String getTb_pj_fone02() {
		return tb_pj_fone02;
	}
	public void setTb_pj_fone02(String tb_pj_fone02) {
		this.tb_pj_fone02 = tb_pj_fone02;
	}
	...
	public String toString() {
		return "Pjuridicas [tb_pj_ddd01=" + tb_pj_ddd01 + ", tb_pj_ddd02="
				+ tb_pj_ddd02 + ", tb_pj_fone01=" + tb_pj_fone01
				+ ", tb_pj_fone02=" + tb_pj_fone02 + ", tb_tipocontato="
				+ tb_tipocontato + ", RECORD_ID=" + RECORD_ID + ", STATE="
				+ STATE + ", STREET_ZIPCODE=" + STREET_ZIPCODE + ", CITY="
				+ CITY + ", DISTRICT=" + DISTRICT + ", STREET_TYPE="
				+ STREET_TYPE + ", STREET_NAME=" + STREET_NAME
				+ ", STREET_COMP=" + STREET_COMP + ", tb_cep_num=" + tb_cep_num
				+ ", tb_numapo=" + tb_numapo + ", tb_numapo_conjug="
				+ tb_numapo_conjug + ", tb_IDPJ=" + tb_IDPJ + ", tb_Cnpj="
				+ tb_Cnpj + ", tb_cep=" + tb_cep + ", tb_cepcorresp="
				+ tb_cepcorresp + ", tb_Razao=" + tb_Razao + ", tb_Qtd_Socio="
				+ tb_Qtd_Socio + ", tb_Contato=" + tb_Contato + ", tb_email="
				+ tb_email + ", tb_ini_ativ=" + tb_ini_ativ + ", Ini_ativ="
				+ Ini_ativ + ", tb_pf_nome=" + tb_pf_nome
				+ ", tb_senha_acesso=" + tb_senha_acesso + ", segmento="
				...
				+ pagencia_combo + ", empresasgrupo=" + empresasgrupo + "]";
	}
